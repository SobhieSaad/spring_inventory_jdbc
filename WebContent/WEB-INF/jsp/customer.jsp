...
<body>
	...
	<div class="container">
		...
		<div class="col-md-12 header">
			<h1 align="center">
				<a href="<%=request.getContextPath()%>/">Spring Inventory</a>
			</h1>
		</div>
		...
		<div class="student_form col-md-4">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						<label for="phone">Address:</label> <input value="${customer.address}"
							name="phone" type="text" class="form-control" id="phone">
					</div>
					<c:if test="${customer.cid != null}">
		...
		<div class="col-md-12" style="text-align: center;">&copy; Sobhie Saad</div>
